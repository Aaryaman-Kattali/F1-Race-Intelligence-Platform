...
class CurrentProcessor:
    ...
    def process_current_intelligence(self, intelligence_data: Dict) -> Dict:
        ...
        try:
            processed_data = {
                "standings": self._process_standings(
                    intelligence_data.get("standings", {})
                ),
                "recent_form": self._process_form_analysis(
                    intelligence_data.get("recent_form", {})
                ),
                "team_updates": self._process_team_updates(
                    intelligence_data.get("team_updates", {})
                ),
                "circuit_specific": self._process_circuit_intelligence(
                    intelligence_data.get("circuit_specific", {})
                ),
        ...
        try:
            ...
            for constructor in constructors:
                processed_constructor = {
                    ...
                    "performance_tier": self._classify_team_performance(
                        constructor.get("position", 10)
                    ),
                }
                processed_standings["constructors"].append(processed_constructor)

            processed_standings["races_completed"] = standings_data.get(
                "races_completed", 0
            )
            ...
            if form_data.get("analysis_available"):
                ...
                for pattern in in_form_patterns:
                    ...
                    for match in matches:
                        ...
                        if (
                            len(driver_code) == 3
                            and driver_code not in processed_form["drivers_in_form"]
                        ):
                ...
                for pattern in struggling_patterns:
                    ...
                    for match in matches:
                        ...
                        if (
                            len(driver_code) == 3
                            and driver_code not in processed_form["drivers_struggling"]
                        ):
                ...
                for pattern in tech_patterns:
                    ...
                    for match in matches:
                        processed_updates["technical_updates"].append(
                            {"description": match, "expected_impact": "positive"}
                        )
